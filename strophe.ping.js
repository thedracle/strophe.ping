let StrophePackage = require('strophe.js');
let Strophe = StrophePackage.Strophe;
...
Strophe.addConnectionPlugin('ping', {
  ...
  ping: function(jid, success, error, timeout) {
    ...
    var iq = StrophePackage.$iq({ type: 'get', to: jid, id: id }).c('ping', {
  ...
  pong: function(ping) {
    ...
    var iq = StrophePackage.$iq({ type: 'result', to: from, id: id });
    this._c.sendIQ(iq);
  },
